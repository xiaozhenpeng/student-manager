...
public class OpenClassViewModel extends ViewModel {
    // TODO: Implement the ViewModel
    private MutableLiveData<ArrayList<CourseTeacher>> mutableLiveData_course_list;

    public OpenClassViewModel() {
    }

    public OpenClassViewModel(MutableLiveData<ArrayList<CourseTeacher>> mutableLiveData_course_list) {
